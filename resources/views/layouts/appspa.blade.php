<!DOCTYPE html>
    ...
    <head>
        ...
        <link type="text/css" href="{{ asset('static/css/main.0006455e.chunk.css') }}" rel="stylesheet">
...
@page {
  ...
  .table .thead-dark th {
    ...
    <body>
        ...
        <script src="{{ asset('static/js/2.4d2aec6a.chunk.js') }}"></script>
        <script src="{{ asset('static/js/main.a891d96b.chunk.js') }}"></script>
