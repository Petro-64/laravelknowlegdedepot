          ...
          @isset($id)
            ...
            <table id="questionsEditTable" class="table"><thead><tr><td>Question Id</td><td>Status</br>(click to change)</td><td>Question</td><td>Edit</td></tr></thead>
                ...
                @foreach ($questions as $question)
                  ...
                  @endphp
                  <tr class="{{ $trClassName }}"><td class="questionId" data-id="{{ $question['id'] }}">{{ $question['id'] }}</td><td class="controlActivness" data-active="{{ $question['active'] }}">{{ $phraze }}</td>
                  <td class="questionText" data-id="{{ $question['id'] }}">{{ $toShow }}</td>
                      <td><button type="button" class="btn btn-primary btn-sm show-answers" data-id="{{ $question['id'] }}" data-active="{{ $question['active'] }}">Edit</button></td></tr>
                @endforeach
              @endif
            </table>
            {{ $questions->links() }}
